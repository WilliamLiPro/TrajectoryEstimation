...
%     drawTrajectorySimple(Ada_traj(1:3,1:i),1,x_min,x_max,y_min,y_max); %¹ì¼£Í¼
...
%     drawTrajectorySimple(MAP_traj(1:3,1:i),1,x_min,x_max,y_min,y_max); %¹ì¼£Í¼
%     drawObserve(obs(1:3,1:i,:),2,x_min,x_max,y_min,y_max);%¹Û²âÍ¼
end
drawTrajectorySimple(MAP_traj(1:3,1:i),1,x_min,x_max,y_min,y_max); %¹ì¼£Í¼
...
%     drawTrajectorySimple(EKF_acc1(1:3,1:i),1,x_min,x_max,y_min,y_max); %¹ì¼£Í¼
%     drawObserve(obs(1:3,1:i,:),2,x_min,x_max,y_min,y_max);%¹Û²âÍ¼
end
drawTrajectorySimple(EKF_acc(1:3,1:i),2,x_min,x_max,y_min,y_max); %¹ì¼£Í¼
...
%     drawTrajectorySimple(EKF_dpt1(1:3,1:i),1,x_min,x_max,y_min,y_max); %¹ì¼£Í¼
%     drawObserve(obs(1:3,1:i,:),2,x_min,x_max,y_min,y_max);%¹Û²âÍ¼
end
drawTrajectorySimple(EKF_dpt(1:3,1:i),3,x_min,x_max,y_min,y_max); %¹ì¼£Í¼
...
%     drawTrajectorySimple(UKF_acc1(1:3,1:i),1,x_min,x_max,y_min,y_max); %¹ì¼£Í¼
%     drawObserve(obs(1:3,1:i,:),2,x_min,x_max,y_min,y_max);%¹Û²âÍ¼
end
drawTrajectorySimple(UKF_acc(1:3,1:i),4,x_min,x_max,y_min,y_max); %¹ì¼£Í¼
...
%     drawTrajectorySimple(UKF_dpt1(1:3,1:i),1,x_min,x_max,y_min,y_max); %¹ì¼£Í¼
%     drawObserve(obs(1:3,1:i,:),2,x_min,x_max,y_min,y_max);%¹Û²âÍ¼
end
drawTrajectorySimple(UKF_dpt(1:3,1:i),5,x_min,x_max,y_min,y_max); %¹ì¼£Í¼
